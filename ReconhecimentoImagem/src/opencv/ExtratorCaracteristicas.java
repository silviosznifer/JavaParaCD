...
public class ExtratorCaracteristicas {
	...
	exportacao += "@data\n";
        ...
        for (int i = 0; i < arquivos.length; i++) {
            ...
            IplImage imagemOriginal = cvLoadImage("imagens/" + arquivos[i].getName());
                        
            CvSize tamanhoImagemOriginal = cvGetSize(imagemOriginal.asCvMat());
    ...
    public String extrator(String caminhoImagem, String nomeImagem) {
     ...
     // Carrega cada imagem do diretório
        IplImage imagemOriginal = cvLoadImage(caminhoImagem + nomeImagem);
     ...
     // Normaliza as características pelo número de pixels totais da imagem
        ...
        System.out.println("Laranja camisa Bart: " + laranjaCamisaBart + " - Azul calção Bart: " + azulCalcaoBart + " - Azul sapato Bart: " + azulSapatoBart + " - Azul calça Homer: " + azulCalcaHomer + " - Marrom boca Homer: " + marromBocaHomer + " - Preto sapato Homer: " + cinzaSapatoHomer + " - Classe: " + classePersonagem);
        return laranjaCamisaBart + "," + azulCalcaoBart + "," + azulSapatoBart + "," + azulCalcaHomer + "," + marromBocaHomer + "," + cinzaSapatoHomer + "," + classePersonagemString + "\n";
